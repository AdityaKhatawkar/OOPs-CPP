...
Abstract classes are the classes that are made with the reason for them to be inherited.
...
If there is no overrider, such error is displayed: 
object of abstract class type "CWHVideo" is not allowed:C/C++(322)
PureVirtualFunction_AbstractBaseClass.cpp(82, 14): pure virtual function "CWH::display" has no overrider
...
public:
    ...
    virtual void display() = 0; //Do nothing. This is a pure virtual function which HAS to be overridden compulsarily by the 
